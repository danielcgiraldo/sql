...
INSERT INTO cities (code,name,state) VALUES
    (5000, '* Antioquia. Mpio. Desconocido', 5),
    (5001, 'Medellin', 5),
    (5002, 'Abejorral', 5),
    (5004, 'Abriaqui', 5),
    (5021, 'Alejandria', 5),
    ...
    (5893, 'Yondo (Casabe)', 5),
    (5895, 'Zaragoza', 5),
    (8000, '* Atlantico. Mpio. Desconocido', 8),
    (8078, 'Baranoa', 8),
    ...
    (9001, 'Barranquilla', 8),
    (11001, 'Bogota', 11),
    (13000, '* Bolivar. Mpio. Desconocido', 13),
    (13006, 'Achi', 13),
    ...
    (13894, 'Zambrano', 13),
    (14001, 'Cartagena', 13),
    (15000, '* Boyaca. Mpio. Desconocido', 15),
    (15001, 'Tunja', 15),
    (15022, 'Almeida', 15),
    (15047, 'Aquitania', 15),
    (15051, 'Arcabuco', 15),
    ...
    (15879, 'Viracacha', 15),
    (15897, 'Zetaquira', 15),
    (17000, '* Caldas. Mpio. Desconocido', 17),
    (17001, 'Manizales', 17),
    (17013, 'Aguadas', 17),
    (17042, 'Anserma', 17),
    (17050, 'Aranzazu', 17),
    ...
    (17873, 'Villamaria', 17),
    (17877, 'Viterbo', 17),
    (18000, '* Caqueta. Mpio. Desconocido', 18),
    (18001, 'Florencia', 18),
    (18029, 'Albania', 18),
    ...
    (18785, 'Solita', 18),
    (18860, 'Valparaiso', 18),
    (19000, '* Cauca. Mpio. Desconocido', 19),
    (19001, 'Popayan', 19),
    (19022, 'Almaguer', 19),
    (19050, 'Argelia', 19),
    (19075, 'Balboa', 19),
    ...
    (19824, 'ToToro', 19),
    (19845, 'Villarica', 19),
    (20000, '* Cesar. Mpio. Desconocido', 20),
    (20001, 'Valledupar', 20),
    (20011, 'Aguachica', 20),
    ...
    (23000, '* Cordoba. Mpio. Desconocido', 23),
    (23001, 'Monteria', 23),
    (23068, 'Ayapel', 23),
    (23079, 'Buenavista', 23),
    (23090, 'Canalete', 23),
    ...
    (23807, 'Tierralta', 23),
    (23855, 'Valencia', 23),
    (25000, '* Cundinamarca. Mpio. Desconoc', 25),
    ...
    (25898, 'Zipacon', 25),
    (25899, 'Zipaquira', 25),
    (27000, '* Choco. Mpio. Desconocido', 27),
    (27001, 'Quibdo', 27),
    (27006, 'Acandi', 27),
    ...
    (41000, '* Huila. Mpio. Desconocido', 41),
    (41001, 'Neiva', 41),
    (41006, 'Acevedo', 41),
    (41013, 'Agrado', 41),
    (41016, 'Aipe', 41),
    ...
    (41872, 'Villavieja', 41),
    (41885, 'Yaguara', 41),
    (44000, '* La Guajira. Mpio. Desconoc.', 44),
    (44001, 'Riohacha', 44),
    (44035, 'Albania', 44),
    (44078, 'Barrancas', 44),
    (44090, 'Dibulla', 44),
    ...
    (44855, 'Urumita', 44),
    (44874, 'Villanueva', 44),
    (47000, '* Magdalena. Mpio. Desconocido', 47),
    (47030, 'Algarrobo', 47),
    (47053, 'Aracataca', 47),
    ...
    (48001, 'Santa Marta', 47),
    (50000, '* Meta. Mpio. Desconocido', 50),
    ...
    (52838, 'Tuquerres', 52),
    (52885, 'Yacuanquer', 52),
    (54000, '* Norte Santander. Mpio. Desc.', 54),
    (54001, 'Cucuta', 54),
    (54003, 'Abrego', 54),
    (54051, 'Arboledas', 54),
    (54099, 'Bochalema', 54),
    ...
    (63000, '* Quindio. Mpio. Desconocido', 63),
    (63001, 'Armenia', 63),
    (63111, 'Buenavista', 63),
    (63130, 'Calarca', 63),
    (63190, 'Circasia', 63),
    ...
    (63594, 'Quimbaya', 63),
    (63690, 'Salento', 63),
    (66000, '* Risaralda. Mpio. Desconocido', 66),
    (66001, 'Pereira', 66),
    (66045, 'Apia', 66),
    (66075, 'Balboa', 66),
    ...
    (66687, 'Santuario', 66),
    (68000, '* Santander. Mpio. Desconocido', 68),
    ...
    (68872, 'Villanueva', 68),
    (68895, 'Zapatoca', 68),
    (70000, '* Sucre. Mpio. Desconocido', 70),
    (70001, 'Sincelejo', 70),
    (70110, 'Buenavista', 70),
    (70124, 'Caimito', 70),
    ...
    (70820, 'Tolu', 70),
    (70823, 'Toluviejo', 70),
    (73000, '* Tolima. Mpio. Desconocido', 73),
    (73001, 'Ibague', 73),
    (73024, 'Alpujarra', 73),
    (73026, 'Alvarado', 73),
    (73030, 'Ambalema', 73),
    ...
    (73873, 'Villarica', 73),
    (76000, '* Valle. Mpio. Desconocido', 76),
    (76001, 'Cali', 76),
    (76020, 'Alcala', 76),
    (76036, 'Andalucia', 76),
    ...
    (76892, 'Yumbo', 76),
    (76895, 'Zarzal', 76),
    (81000, '* Arauca. Mpio. Desconocido', 81),
    (81001, 'Arauca', 81),
    (81065, 'Arauquita', 81),
    ...
    (81736, 'Saravena', 81),
    (81794, 'Tame', 81),
    (85000, '* Casanare. Mpio. Desconocido', 85),
    (85001, 'Yopal', 85),
    (85010, 'Aguazul', 85),
    (85015, 'Chameza', 85),
    ...
    (85430, 'Trinidad', 85),
    (85440, 'Villanueva', 85),
    (86000, '* Putumayo. Mpio. Desconocido', 86),
    (86001, 'Mocoa', 86),
    (86219, 'Colon', 86),
    (86320, 'Orito', 86),
    ...
    (88000, '* San Andres y Pr. Mpio. Desc.', 88),
    (88001, 'San Andres', 88),
    (88564, 'Providencia', 88),
    (91000, '* Amazonas. Mpio. Desconocido', 91),
    (91001, 'Leticia', 91),
    ...
    (94000, '* Guainia. Mpio. Desconocido', 94),
    ...
    (95000, '* Guaviare. Mpio. Desconocido', 95),
    (95001, 'San Jose del Guaviare', 95),
    (95015, 'Calamar', 95),
    (95025, 'El Retorno', 95),
    (95200, 'Miraflores', 95),
    (97000, '* Vaupes. Mpio. Desconocido', 97),
    (97001, 'Mitu', 97),
    (97161, 'Caruru', 97),
    (97511, 'Pacoa (CD)', 97),
    (97666, 'Taraira', 97),
    ...
    (99000, '* Vichada. Mpio. Desconocido', 99),
